...
public class WorkflowInternalActionVerticleTest {
	...
	@InjectMocks
	private WorkflowInternalActionVerticle workflowEventUpdateVerticle = new WorkflowInternalActionVerticle() {
		@Override
	...
	public void testProcessSuccess() {
		...
		workflowEventDto.setActionCode("PAUSED");
		workflowEventDto.setActionMessage("packet is paused");
